...
# Mengunduh resource yang dibutuhkan NLTK
nltk.download('punkt')
...
try:
    ...
    st.error("Model atau TF-IDF vectorizer tidak ditemukan. Pastikan file 'logistic_regression_model.pkl' dan 'tfidf_vectorizer.pkl' ada di direktori.")
